...
def count_melons_dc(melon_list):

    melon_counts = {melon:sum(1 for melon2 in melon_list if melon2 == melon) for melon in melon_list}

    return melon_counts

print(count_melons_dc(melons_to_add))